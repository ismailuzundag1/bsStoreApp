...
{
    public class Entity : DynamicObject, IXmlSerializable, IDictionary<string, object> //IXmlSerializable(Serileşmesini sağlar), IDictionary(Key anahtar tutmasını sağlar.)
    {
